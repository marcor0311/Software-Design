...
namespace EFoodCommerce.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var se = await _emailStore.FindByEmailAsync(Input.Email, CancellationToken.None);
                if (se != null)
                {
                ...
                {
                    Nombre = Input.Nombre,
                    Pregunta_Seguridad = Input.Pregunta_Seguridad,
                    Respuesta_Seguridad = Input.Respuesta_Seguridad,
                    Email = Input.Email
                };
